...
Added: Error checking, if mpv is not started, or if a video in the playlist is deleted

Added: Using our custom binary to send notification to the desktop using DBUS plain C library.
